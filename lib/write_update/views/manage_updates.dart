...
import 'package:icare_tagum_admin/write_update/services/delete_update.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              width: 155,
              child: StreamBuilder<List<UpdateDetails>>(
                                  ...
                                  DataCell(Row(
                                    children: [
                                      ...
                                      IconButton(
                                        onPressed: () {
                                          deleteUpdate(
                                              context, updateDetails.dateTime);
                                        },
                                        icon: const Icon(
